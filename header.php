...
<body <?php body_class(); ?>>
    ...
    <header class="header w-full bg-[#fff] z-50 py-3 xl:py-0 px-[30px] xl:px-[15px]">
        <div class="max-w-[1225px] mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center ml-[-21px]">
                ...
                wp_nav_menu(array(
                    ...
                    'menu_class' => 'nav__links flex items-center gap-[10px] xl:gap-[30px]  text-[20px] font-bebas-pro font-bold   leading-normal tracking-[0.4px] uppercase text-[#000] py-10',
                ...
                <!-- <nav id="nav-links" class="hidden lg:flex">
                    <ul
                        class="nav__links flex items-center gap-[20px] lg:gap-[30px] text-[20px] font-bebas-pro font-bold   leading-normal tracking-[0.4px] uppercase text-[#000] py-10">
            ...
            <div class="flex lg:hidden items-center gap-6">
                ...
                <!-- <button id="menu-close" aria-label="Close menu"
          class="hidden w-[45px] h-[45px] rounded-full  items-center justify-center bg-white hover:bg-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F65600] text-[#F65600]">
          <i class="ri-close-line text-2xl" aria-hidden="true"></i>
            ...
            wp_nav_menu(array(
                ...
                'container_class' => 'flex opacity-0 translate-x-0 fixed top-[77px] right-0 h-screen w-[260px] bg-[#ffffff] px-4 py-8 shadow-lg z-50 lg:hidden transition-all duration-500 ease-in-out',
            ...
            <!-- 
            <nav id="mobile-nav"
                class="flex opacity-0 translate-x-0 fixed top-[77px] right-0 h-screen w-[260px] bg-[#ffffff] px-4 py-8 shadow-lg z-50 lg:hidden transition-all duration-500 ease-in-out">
                <ul class="flex flex-col   gap-5 text-[16px] font-bold leading-[20px] text-[#031F42]">
                    ...
                    <li><a href="contact.html">Contact Us</a></li>
                    <li>
                        <a href="enter-competition.html" class="inline-flex font-normal sm:hidden enter-btn font-bebas-pro">Enter Competition</a>
                    </li>
                </ul>
            </nav> -->
        </div>
